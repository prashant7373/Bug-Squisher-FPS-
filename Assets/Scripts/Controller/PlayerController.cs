...
public class PlayerController : MonoBehaviour
{
    ...
    [Tooltip("The speed at which the player rotates to move left or right (calculated in degrees)")]
    ...
    private void SetUpCharacterController()
    {
        ...
        if (controller == null)
        {
            Debug.LogError("The player controller script does not have the the charater controller");
        }
    }
    ...
    void ProcessMovement()
    {
        ...
        if(controller.isGrounded)
        {
            ...
            // Set the movement direction to be the received input, set y to 0 since we are on ground
        ...
        {
            moveDirection = new Vector3(leftRightInput * moveSpeed, moveDirection.y, forwardBackwardInput);
            moveDirection = transform.TransformDirection(moveDirection);
